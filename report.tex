...
\begin{equation}
	\tilde{\nabla} \times ( \mu^{-1} \tilde{\nabla} \times \mathbf{E} ) + k^{2} \mathbf{E} = - i \omega \mathbf{J} , \label{eq:helmholtz_pml}
\end{equation}
...
\begin{equation*}
	\begin{cases}
		...
		\displaystyle
		\int\limits_{\tilde{\Omega}} \mu^{-1} \tilde{\nabla} \times \mathbf{E} \cdot \tilde{\nabla} \times \mathbf{v}^{*} \,d\tilde{\Omega} + \int\limits_{\tilde{\Omega}} k^{2} \mathbf{E} \cdot \mathbf{v}^{*} \,d\tilde{\Omega} = - \int\limits_{\tilde{\Omega}} i \omega \mathbf{J} \cdot \mathbf{v}^{*} \,d\tilde{\Omega} . \\
	\end{cases}
\end{equation*}
